...
{block name="field"}
        {if $input.type == 'setting_list'}
            <ol class="breadcrumb leo-redirect">
                ...
                <li><a href="#" data-element="fieldset_1">{l s='PAGES SETTING'}</a></li>
                <li><a href="#" data-element="fieldset_2">{l s='CUSTOMIZATION SETTING'}</a></li>
                <li><a href="#" data-element="fieldset_3">{l s='FONT SETTING'}</a></li>
                <li><a href="#" data-element="fieldset_4">{l s='DATA SAMPLE'}</a></li>
            </ol>
        {/if}

...
class leoblog extends Module {
    ...
    public function install() {
        /* Adds Module */
        if (parent::install() && $this->registerHook('top') && $this->registerHook('displayNav') && $this->registerHook('leftColumn') && $this->registerHook('moduleRoutes')&&$this->registerHook('displayBackOfficeHeader')

		...
		<div class="functional-buttons clearfix">
			<div class="action-button">
				...
				{if isset($comparator_max_item) && $comparator_max_item}
					<div class="compare">
						<a class="add_to_compare compare btn btn-tooltip" href="{$product.link|escape:'html':'UTF-8'}" data-id-product="{$product.id_product}" title="{l s='Add to compare'}" >
				...
				{if isset($quick_view) && $quick_view}
				  <div class="button-quick-view">
					<a class="quick-view btn btn-tooltip" href="{$product.link|escape:'html':'UTF-8'}" rel="{$product.link|escape:'html':'UTF-8'}" title="{l s='Quick view'}" >
		...
		<div class="product-meta">
			...
			<div class="functional-cart-detail">
				...
				<div class="detail-link">
					<a itemprop="url" class="button lnk_view btn btn-outline" href="{$product.link|escape:'html':'UTF-8'}" title="{l s='Detail'}">

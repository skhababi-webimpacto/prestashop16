	...
	<form action="{$link->getPageLink('address', true)|escape:'html':'UTF-8'}" method="post" class="std form-horizontal" id="add_address">
		...
		{foreach from=$ordered_adr_fields item=field_name}
			...
			<div class="required form-group">
				<label class="control-label col-sm-4 col-md-4" for="dni">{l s='Identification number'}</label>
				<div class="col-sm-6 col-md-6">
		...
		<div class="required form-group" id="adress_alias">
			<label class="control-label col-sm-4 col-md-4" for="alias">{l s='Please assign an address title for future reference.'} <sup>*</sup></label>
			<div class="col-sm-6 col-md-6">

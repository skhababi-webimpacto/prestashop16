...
<div class="adresses_bloc">
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-6"{if $order->isVirtual()} style="display:none;"{/if}>
...
<div id="order-detail-content" class="table_block table-responsive">
	<table class="table table-bordered">
		...
		{foreach from=$products item=product name=products}
			...
			<!-- Start Said -->
			<!-- Hook number_sales here: execute the check number of sales for each product -->
			<!-- pass an array of products ordered to smarty -->
			{append var='productarr' value=products index=product}
			<!-- End Said -->

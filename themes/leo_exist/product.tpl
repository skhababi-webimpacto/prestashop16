...
{if $errors|@count == 0}
	...
	<div class="primary_block row block" itemscope itemtype="http://schema.org/Product">
		...
		{/if}
		<!-- left infos-->  
		<div class="pb-left-column col-xs-12 col-sm-6 col-md-4 col-lg-4">
			<!-- product img-->        
			...
			{if isset($images) && count($images) > 0}
				...
				<div id="views_block" class="clearfix {if isset($images) && count($images) < 2}hidden{/if}">
					{if isset($images) && count($images) > 4}
						<span class="view_scroll_spacer carousel-controls">
							<a id="view_scroll_left" class="carousel-control left" title="{l s='Other views'}" href="javascript:{ldelim}{rdelim}">&lsaquo;</a>
							<a id="view_scroll_right" class="carousel-control right" title="{l s='Other views'}" href="javascript:{ldelim}{rdelim}">&rsaquo;</a>
						</span>
					{/if}
		...
		<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4"> <!-- modified by said from box-info-product-->
			...
			<div class="box-cart-bottom">
				...
				{/if}
				<div class="pull-left" {if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || (isset($restricted_country_mode) && $restricted_country_mode) || $PS_CATALOG_MODE} class="unvisible"{/if}>
					<p id="add_to_cart" class="buttons_bottom_block no-print">
						<button id="addtocartbtn" type="submit" name="Submit" class="button exclusive btn btn-outline">
								...
								<fieldset class="attribute_fieldset">
									...
									<div class="attribute_list">
										...
										{elseif ($group.group_type == 'radio')}
											<ul class="radiobox">
												{foreach from=$group.attributes key=id_attribute item=group_attribute}
													<!-- Added by Said: onclick = changeStyleRadio(***); -->
													<li class="sizebox">
		...
		<script text="javascript">
			 window.addEventListener("scroll", showCurtain);

			 function showCurtain(){

				 /* Get distance to bottom for the add to cart button */
				 var addtocart = document.getElementById("addtocartbtn");
				 var rectBtn = addtocart.getBoundingClientRect();
				 topbtn = rectBtn.top;
				 heightbtn = rectBtn.height;
				 tobottomBtn = (topbtn + heightbtn);

				 /* Get distance to bottom edge for the header */
				 var header = document.getElementById("header");
				 var rectHeader = header.getBoundingClientRect();
				 topheader = rectHeader.top;
				 heightheader = rectHeader.height;
				 tobottomHeader = (topheader + heightheader);

				 /* Test two distances and change class value */
				 if(tobottomBtn <= tobottomHeader){
					 document.getElementById('header-curtain').setAttribute("class","curtainon");
					//  document.getElementById('header-curtain').style.height = "300px";

				 }else{
					  document.getElementById('header-curtain').setAttribute("class","curtainoff");
					// document.getElementById('header-curtain').style.height = "0px";
				 }

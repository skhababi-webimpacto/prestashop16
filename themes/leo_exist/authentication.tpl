			...
			<div class="box">
				<div id="opc_account_form" style="display: block; ">
					...
					<div class="required form-group">
						<label class="control-label col-sm-4 col-md-4 " for="guest_email">{l s='Email address'} <sup>*</sup></label>
					...
					<div class="cleafix gender-line">
						<label class="control-label col-sm-4 col-md-4">{l s='Title'}</label>
						<div class="col-sm-6 col-md-6">
					...
					{foreach from=$dlv_all_fields item=field_name}
						{if $field_name eq "company" && $b2b_enable}
							<div class="form-group">
								<label class="control-label col-sm-4 col-md-4" for="company">{l s='Company'}</label>
								<div class="col-sm-6 col-md-6">
						...
						{elseif $field_name eq "vat_number"}
							<div id="vat_number" style="display:none;">
								<div class="form-group">
									<label class="control-label col-sm-4 col-md-4" for="vat-number">{l s='VAT number'}</label>
									<div class="col-sm-6 col-md-6">
						...
						{elseif $field_name eq "Country:name" || $field_name eq "country"}
							<div class="required select form-group">
								<label class="control-label col-sm-4 col-md-4 col-lg-4" for="id_country">{l s='Country'} <sup>*</sup></label>
						...
						{elseif $field_name eq "State:name"}
							...
							<div class="required id_state select form-group">
								<label class="control-label col-sm-4 col-md-4 col-lg-4" for="id_state">{l s='State'} <sup>*</sup></label>
								<div class="col-sm-6 col-md-6 col-lg-6">
					...
					<div id="opc_invoice_address"  class="unvisible">
						...
						{if $field_name eq "company" && $b2b_enable}
						<div class="form-group">
							<label class="control-label col-sm-4 col-md-4" for="company_invoice">{l s='Company'}</label>
							<div class="col-sm-6 col-md-6">
						...
						<div id="vat_number_block_invoice" class="is_customer_param" style="display:none;">
							<div class="form-group">
								<label class="control-label col-sm-4 col-md-4" for="vat_number_invoice">{l s='VAT number'}</label>
								<div class="col-sm-6 col-md-6">
						...
						{elseif $field_name eq "address2"}
						<div class="form-group is_customer_param">
							<label class="control-label col-sm-4 col-md-4" for="address2_invoice">{l s='Address (Line 2)'}</label>
							<div class="col-sm-6 col-md-6">
...
{else}
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="account-creation_form" class="std box form-horizontal">
		...
		<div class="account_creation">
			...
			<div class="required form-group">
				<label class="control-label col-sm-4 col-md-4" for="customer_firstname">{l s='First name'} <sup>*</sup></label>
				<div class="col-sm-6 col-md-6">
			...
			<div class="required form-group">
				<label class="control-label col-sm-4 col-md-4" for="customer_lastname">{l s='Last name'} <sup>*</sup></label>
				<div class="col-sm-6 col-md-6">
		...
		{if $b2b_enable}
			<div class="account_creation">
				...
				<div class="form-group">
					<label class="control-label col-sm-4 col-md-4" for="">{l s='Company'}</label>
					<div class="col-sm-6 col-md-6">
						<input type="text" class="form-control" id="company" name="company" value="{if isset($smarty.post.company)}{$smarty.post.company}{/if}" />
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-sm-4 col-md-4" for="siret">{l s='SIRET'}</label>
					<div class="col-sm-6 col-md-6">
						<input type="text" class="form-control" id="siret" name="siret" value="{if isset($smarty.post.siret)}{$smarty.post.siret}{/if}" />
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-sm-4 col-md-4" for="ape">{l s='APE'}</label>
					<div class="col-sm-6 col-md-6">
						<input type="text" class="form-control" id="ape" name="ape" value="{if isset($smarty.post.ape)}{$smarty.post.ape}{/if}" />
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-sm-4 col-md-4" for="website">{l s='Website'}</label>
					<div class="col-sm-6 col-md-6">
			...
			<div class="account_creation">
				...
				{foreach from=$dlv_all_fields item=field_name}
					...
					{elseif $field_name eq "vat_number"}
						<div id="vat_number" style="display:none;">
							<div class="form-group">
								<label class="control-label col-sm-4 col-md-4" for="vat_number">{l s='VAT number'}</label>
								<div class="col-sm-6 col-md-6">
					...
					{elseif $field_name eq "address2"}
						<div class="form-group is_customer_param">
							<label class="control-label col-sm-4 col-md-4" for="address2">{l s='Address (Line 2)'}</label>
							<div class="col-sm-6 col-md-6">
								<input type="text" class="form-control" name="address2" id="address2" value="{if isset($smarty.post.address2)}{$smarty.post.address2}{/if}" />
				...
				<div class="required form-group" id="address_alias">
					<label class="control-label col-sm-4 col-md-4" for="alias">{l s='Assign an address alias for future reference.'} <sup>*</sup></label>
					<div class="col-sm-6 col-md-6">

			...
			<div class="cart-inner media-body">
				<div class="mini-cart">
					...
					<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
						<span class="hidden-lg hidden-md hidden-sm hidden-xs ajax_cart_total{if $cart_qties == 0} unvisible{/if}">
							{if $cart_qties > 0}
								{if $priceDisplay == 1}
						...
						<span class="hidden-lg hidden-md hidden-sm hidden-xs ajax_cart_product_txt{if $cart_qties != 1} unvisible{/if}">{l s='item' mod='blockcart'}</span>
						<span class="hidden-lg hidden-md hidden-sm hidden-xs ajax_cart_product_txt_s{if $cart_qties < 2} unvisible{/if}">{l s='item(s)' mod='blockcart'}</span>
											...
											{foreach from=$customizedDatas.$productId.$productAttributeId[$product.id_address_delivery] key='id_customization' item='customization' name='customizations'}
												<li name="customization">
													<div data-id="deleteCustomizableProduct_{$id_customization|intval}_{$product.id_product|intval}_{$product.id_product_attribute|intval}_{$product.id_address_delivery|intval}" class="deleteCustomizableProduct">
														<a class="ajax_cart_block_remove_link" href="{$link->getPageLink("cart", true, NULL, "delete=1&amp;id_product={$product.id_product|intval}&amp;ipa={$product.id_product_attribute|intval}&amp;id_customization={$id_customization}&amp;token={$static_token}", true)|escape:"html":"UTF-8"}" rel="nofollow"><i class="fa fa-trash-o"></i></a>
													</div>
